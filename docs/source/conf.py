...
project = u'MediCurator'
copyright = u'2016, Yiru Chen'
author = u'2016, Yiru Chen'
...
latex_documents = [
  (master_doc, 'MediCurator.tex', u'MediCurator Documentation',
   u'MediCurator Team', 'manual'),
]
